...
public final class AWSS3StorageUploadInputStreamOptions extends StorageUploadInputStreamOptions {
    ...
    /**
     * S3 storage class for the uploaded object.
    ...
    public static final class Builder extends StorageUploadInputStreamOptions.Builder<Builder> {
        ...
        /**
         * Configures the S3 storage class for a new AWSS3StorageUploadInputStreamOptions instance.
         * @param storageClass S3 storage class (e.g., StorageClass.GlacierIr)
         * @return Current Builder instance for fluent chaining
         */
        @NonNull
